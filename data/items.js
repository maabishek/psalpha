...
let BattleItems = {
  ...
  kingsrock: {
    ...
    gen: 2,
    desc:
      "Holder's attacks without a chance to flinch gain a 10% chance to flinch. Evolves Poliwhirl into Politoed and Slowpoke into Slowking when traded.",
    shortDesc:
  ...
  protectivepads: {
    ...
    onAttract: function(target, source, effect) {
      if (
        target !== source &&
        target === this.activePokemon &&
        this.activeMove &&
        this.activeMove.flags["contact"]
      )
        return false;
    },
    onBoostPriority: -1,
  ...
  razorfang: {
    ...
    gen: 4,
    desc:
      "Holder's attacks without a chance to flinch gain a 10% chance to flinch. Evolves Gligar into Gliscor when held and leveled up during the night.",
    shortDesc:
      "Holder's attacks without a chance to flinch gain a 10% chance to flinch."
  },
  razzberry: {
  ...
  spaceorb: {
    ...
    onPrimal: function(pokemon) {
      pokemon.formeChange("Palkia-Primal", this.effect, true);
    },
    onTakeItem: function(item, source) {
    ...
    gen: 7,
    desc:
      "If held by a Palkia, this item triggers its Primal Reversion in battle."
  },
  jeweloflife: {
    id: "jeweloflife",
    name: "Jewel Of Life",
    ...
    onPrimal: function(pokemon) {
      pokemon.formeChange("Arceus-TheOne", this.effect, true);
    },
    onTakeItem: function(item, source) {
    ...
    num: -5,
    gen: 7,
    desc: "If held by an Arceus, this item triggers its True Form in battle."
  },
    infernite: {
    id: "infernite",
    name: "Infernite",
  ...
  jewelofdeath: {
    ...
    onPrimal: function(pokemon) {
      pokemon.formeChange("Giratina-True", this.effect, true);
    },
    onTakeItem: function(item, source) {
    ...
    num: -6,
    gen: 7,
    desc: "If held by a Giratina, this item triggers its True Form in battle."
  },
    hydratite: {
    id: "hydratite",
    name: "Hydratite",
    ...
    gen: 7,
    desc:
      "If held by a Hydreigon, this item allows it to Mega Evolve in battle."
  },
    dracotite: {
    id: "dracotite",
    name: "Dracotite",
    ...
    gen: 7,
    desc:
      "If held by a Shadow-Mewtwo, this item allows it to Mega Evolve in battle."
  },
      bisharpiteite: {
    id: "bisharpite",
    name: "Bisharpite",
    ...
    gen: 7,
    desc:
      "If held by a Bisharp, this item allows it to Mega Evolve in battle."
  },
    ...
    gen: 7,
    desc:
      "If held by a Flygon, this item allows it to Mega Evolve in battle."
  },
      snorlaxite: {
    id: "snorlaxite",
    name: "Snorlaxite",
    ...
    gen: 7,
    desc:
      "If held by a Snorlax, this item allows it to Mega Evolve in battle."
  },
        talonflamite: {
    id: "talonflamite",
    name: "Talonflamite",
    ...
    gen: 7,
    desc:
      "If held by a Talonflame, this item allows it to Mega Evolve in battle."
  },
          meganiumite: {
    id: "meganiummite",
    name: "Meganiummite",
    ...
    gen: 7,
    desc:
      "If held by a Typhlosion, this item allows it to Mega Evolve in battle."
  },
          feraligatrite: {
    id: "feraligatrite",
    name: "Feraligatrite",
    ...
    gen: 7,
    desc:
      "If held by an Arcanine, this item allows it to Mega Evolve in battle."
  },
              crobatite: {
    id: "crobatite",
    name: "Crobatite",
    ...
    gen: 7,
    desc:
      "If held by an Crobat, this item allows it to Mega Evolve in battle."
  },
};
